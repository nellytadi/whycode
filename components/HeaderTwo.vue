      ...
      <div class="container clearfix">
        ...
        <div class="logo-box clearfix">
          <a class="navbar-brand" href="/">
            <img src="/assets/images/resources/logo-white.png" class="main-logo" width="119" alt="Awesome Image" />
          </a>
        ...
        <div class="right-side-box">
          <a class="thm-btn header__cta-btn" href="/contact"><span>Contact</span></a>
        </div><!-- /.right-side-box -->
      </div>
      <!-- /.container -->
    </nav>
